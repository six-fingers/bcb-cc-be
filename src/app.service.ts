...
import {
  ...
  IccCurrencies,
  IccResponse,
} from './interfaces/crypto-compare.interface';
...
export class AppService {
  ...
  private _getCurrentTradingObservable(): Observable<
    AxiosResponse<IccResponse>
  > {
  ...
  private _mapCryptoCurrencies(
    cryptoCurrencies: IccCryptoCurrencies,
  ): ICryptoCurrrency[] {
